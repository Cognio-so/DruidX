...
import { 
    ...
    Bold, Heading1, Heading2, Heading3, Italic, 
    ListIcon, ListOrdered, Redo, Strikethrough, Undo 
} from "lucide-react";
        ...
        <div className="border border-input border-t-0 border-x-0 rounded-t-lg p-2 bg-card flex flex-wrap gap-1 items-center">
            <TooltipProvider>
                ...
                <div className="flex flex-wrap gap-1 items-center">
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle size="sm" pressed={editor.isActive('orderList')}
                                onPressedChange={() => editor.chain().focus().toggleOrderedList().run()}
                                className={cn(editor.isActive('orderList') && "bg-muted text-muted-foreground")}
                            >
                                <ListOrdered />
                            </Toggle>
                        </TooltipTrigger>
                ...
                <div className="flex items-center gap-1">
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle size="sm" pressed={editor.isActive('textAlign', { align: 'left' })}
                                onPressedChange={() => editor.chain().focus().setTextAlign('left').run()}
                                className={cn(editor.isActive('textAlign', { align: 'left' }) && "bg-muted text-muted-foreground")}
                            >
                                <AlignLeft />
                            </Toggle>
                        </TooltipTrigger>
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle size="sm" pressed={editor.isActive('textAlign', { align: 'center' })}
                                onPressedChange={() => editor.chain().focus().setTextAlign('center').run()}
                                className={cn(editor.isActive('textAlign', { align: 'center' }) && "bg-muted text-muted-foreground")}
                            >
                                <AlignCenter />
                            </Toggle>
                        </TooltipTrigger>
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle size="sm" pressed={editor.isActive('textAlign', { align: 'right' })}
                                onPressedChange={() => editor.chain().focus().setTextAlign('right').run()}
                                className={cn(editor.isActive('textAlign', { align: 'right' }) && "bg-muted text-muted-foreground")}
                            >
                                <AlignRight />
                            </Toggle>
                        </TooltipTrigger>
